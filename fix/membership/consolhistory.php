...
require_once __DIR__ . '/../../scripts/bootstrap.php';
echo $rowz['MemberFirstname']." ".$rowz['MemberSurname']; ?></th>
                    ...
                    <td scope="col"><?php
require_once __DIR__ . '/../../scripts/bootstrap.php';
echo $rowz['RetirementFundID']; ?></td>
                    <th scope="col" style="vertical-align: top;">MemberNo</th>
					<td scope="col"><?php
require_once __DIR__ . '/../../scripts/bootstrap.php';
echo $rowz['MemberNo']; ?></td>
...
require_once __DIR__ . '/../../scripts/bootstrap.php';
echo "E ". number_format($rowz['ApprovedBenefit'], 2); ?></td>
                    <th scope="col" style="vertical-align: top;">Terminated</th>
					<td scope="col"><?php
require_once __DIR__ . '/../../scripts/bootstrap.php';
echo $rowz['Terminated']; ?></td>
