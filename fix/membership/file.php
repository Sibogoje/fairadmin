      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <a href="newfile.php"><h6 class="bi bi-plus-lg" 
              style="margin-top: 15px; color: white; padding: 5px; font-weight: bold; font-size: 17px; background-color: orange; width: 100px; border-radius: 10px; ">Add File</h6></a>
        ...
        <tbody>
           ...
           // echo $ids;
            ...
            $sql = "SELECT *FROM tblfiles where member = '$ids'";
            ...
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    <a href='uploads/".$row['member']."/".$row['name']."' target='_blank' class='bi bi-folder-x' style='font-size: 25px; color: red;'></a>
