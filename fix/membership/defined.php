    ...
    foreach ($appConfigCandidates as $appConfigPath) {
        if (file_exists($appConfigPath)) {
            ...
            break;
                  ...
                  <button type="submit"  class="btn btn-warning add"  formaction="definedcsv.php"   style="width: 100%;"><b>Download Balance as CSV</b></button>
               </div>
               <!-- <div class="text-center" >
