...
<div class="card col-lg-12" style="">
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="assetscsv.php"  enctype="multipart/form-data" novalidate>
...
echo $row12['RetirementFundID']." - ".$row12['FundName'] ; ?></option>
						<?php
if (!defined('APP_URL')) {
    $appConfigCandidates = array(
        __DIR__ . '/scripts/app_config.php',
