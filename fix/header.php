...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <div class="d-flex align-items-center justify-content-between">
    ...
    <span style="position:absolute; right:10px; top:5px; font-size:10px; color:red; z-index:10000;">FIX:<?=$_DEBUG_ROLE?>:<?=implode(',',array_keys(array_filter($_DEBUG_SHOW)))?></span>
  </div>
