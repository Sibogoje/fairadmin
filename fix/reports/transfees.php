...
<head>
  ...
  <title>Transaction Fees Reports</title>
    ...
    foreach ($appConfigCandidates as $appConfigPath) {
        if (file_exists($appConfigPath)) {
            ...
            break;
                  ...
                  <button type="submit"  class="btn btn-warning add"  formaction="transfeescsv.php"   style="width: 100%;"><b>Download Transaction Fees Report as CSV</b></button>
               </div>
                <div class="text-center" >
                  <button type="submit"  class="btn btn-warning add" formaction="transfeesprint.php" target="_blank"   style="width: 100%;"><b>Download Transaction Fees Report as PDF</b></button>
               </div>
