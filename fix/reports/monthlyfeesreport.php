    ...
    foreach ($appConfigCandidates as $appConfigPath) {
        if (file_exists($appConfigPath)) {
            ...
            break;
                  ...
                  <button type="submit"  class="btn btn-warning add"  formaction="monthlyfeescsv.php"   style="width: 100%;"><b>Download Monthly Fees Report as CSV</b></button>
               </div>
                <div class="text-center" >
                  <button type="submit"  class="btn btn-warning add" formaction="monthlyfeesprint.php" target="_blank"   style="width: 100%;"><b>Download Monthly Fees Report as PDF</b></button>
               </div>
