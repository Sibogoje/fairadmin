...
<head>
  ...
  <title>Intitial Fees Reports</title>
    ...
    foreach ($appConfigCandidates as $appConfigPath) {
        if (file_exists($appConfigPath)) {
            ...
            break;
                  ...
                  <button type="submit"  class="btn btn-warning add"  formaction="initialfeescsv.php"   style="width: 100%;"><b>Download Initial Fees Report as CSV</b></button>
               </div>
                <div class="text-center" >
                  <button type="submit"  class="btn btn-warning add" formaction="initialfeesprint.php" target="_blank"   style="width: 100%;"><b>Download Initial Fees Report as PDF</b></button>
               </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" id="jj">
              <h5 class="card-title">Initial Fees Report</h5>
