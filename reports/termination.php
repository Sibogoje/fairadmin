...
<head>
  ...
  <title>Termination Reports</title>
...
<div class="card col-lg-12" style="">
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="transactioncsv.php"  enctype="multipart/form-data" novalidate>
			   ...
			   <div class="col-md-6">
                  ...
                  <div class="form-floating">
					...
					<option value="all">All</option>
						<?php 
						$stmt12 = $conn->prepare("SELECT DISTINCT * FROM `tblmembers` where `Terminated` = '1' ");
						$stmt12->execute();
                  ...
                  <button type="submit"  class="btn btn-warning add" id="xxx" data-link="" data-id="rr"  style="width: 100%;"><b>Download Termination Report as CSV</b></button>
               </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" id="jj">
              <h5 class="card-title">Termination Report</h5>
