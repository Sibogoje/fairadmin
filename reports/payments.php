...
<script src='jquery-3.2.1.min.js' type='text/javascript'></script>
  ...
  <link href="<?php echo APP_URL; ?>logo.ong" rel="apple-touch-icon">
            ...
            <div class="card-body">
			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post"  target="_blank"  enctype="multipart/form-data" novalidate>
                  ...
                  <div class="form-floating">
                    ...
                    <label for="floatingName"><b>Payment Type:</b></label>
    ...
    foreach ($appConfigCandidates as $appConfigPath) {
        if (file_exists($appConfigPath)) {
            ...
            break;
                  ...
                  <button type="submit"  class="btn btn-warning add"  formaction="paymentscsv.php"   style="width: 100%;"><b>Download Individual Payments Report as CSV</b></button>
               </div>
                <div class="text-center" >
                  <button type="submit"  class="btn btn-warning add" formaction="paymentsprint.php"   style="width: 100%;"><b>Download Individual Payments Report as PDF</b></button>
               </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body" id="jj">
              <h5 class="card-title">Individual Payments Report</h5>
