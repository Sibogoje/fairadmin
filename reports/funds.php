			  ...
			  <form class="row g-3 needs-validation" id="user_form" method="post" action="fundcsv.php"  enctype="multipart/form-data" novalidate>
			   ...
			   <div class="col-md-6">
                  <div class="form-floating">
                    <input type="date" class="form-control" id="date1" placeholder="AdHocPayment"  name="date1" required>
				  ...
				  <div class="valid-feedback">
				   ...
				   <div class="col-md-6">
                  <div class="form-floating">
                    <input type="date"  class="form-control" id="date2" placeholder="AdHocPayment"  name="date2" required>
        ...
        <div class="col-md-3">
          ...
          <div class="col-md-3">
                  <div class="form-floating">
                    ...
                    <label for="floatingName"><b>Sum Trans. Fees:</b></label>
				  <div class="valid-feedback">
                    Looks good!
                  </div>
                  </div>
          ...
          <div class="col-md-3">
                  <div class="form-floating">
                    ...
                    <label for="floatingName"><b>Sum Add. Capital:</b></label>
				  <div class="valid-feedback">
                    Looks good!
                  </div>
                  </div>
