...
echo $ii;?> Payements Print</title></title>
		...
		<table class="table datatable responsive"  id="free" style="margin-top: 20px; width: 100%; text-align: left;">
			<thead>
			    ...
			    <TR style="border: 0px;">
			        ...
			        <H2><span style="text-align: left;"><?php
if (!defined('APP_URL')) {
    $appConfigCandidates = array(
        __DIR__ . '/scripts/app_config.php',
        dirname(__DIR__) . '/scripts/app_config.php',
...
$count++;
			$AMOUNT = $AMOUNT + $row12['Amount'];
						...
						?>
						 ...
						 <h3 style="text-align: right;">Total <?php
if (!defined('APP_URL')) {
    $appConfigCandidates = array(
        __DIR__ . '/scripts/app_config.php',
        dirname(__DIR__) . '/scripts/app_config.php',
