<?php
/**
 * CREATE DIRECT INSERT STATEMENTS FOR FEBRUARY 2026 ADHOCS
 * Read CSV and generate individual INSERT statements
 */

$csv_file = __DIR__ . '/../FEB 2026 ADHOCS.csv';
...
echo "Processing " . count($rows) . " rows from February CSV...\n\n";

// Output SQL
$output = "-- =====================================================\n";
$output .= "-- INSERT ADHOC TRANSACTIONS - FEB 2026\n";
...
$output .= "WHERE PaymentDate >= '2026-02-01';\n";

// Write to file
$sql_file = __DIR__ . '/adhocs_feb_' . date('YmdHis') . '.sql';
